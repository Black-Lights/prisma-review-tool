...
### Added
- **About modal**: Click the version number in the sidebar footer to see app info — version, author, license, requirements, PRISMA standard reference, citation text (selectable), and links to GitHub, Issues, and Changelog.

### Fixed
- Sidebar footer version was hardcoded to v1.2.0 — now shows correct version.
